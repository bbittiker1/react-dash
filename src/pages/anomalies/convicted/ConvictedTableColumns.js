...
export default function ConvictedTableColumns({ props, currentUserId }) {
    const timeFormatter = (ts) => {
        ...
        return (
            <div style={{textAlign: 'center'}}>
                <Moment key={Math.random().toString()} unix >{ts}</Moment>
            </div>
        );
    };
    ...
    return [
        ...
        },
        {
            ...
            render: rowData => <Moment>{rowData.convicted_at}</Moment>,
            filtering: false
        },
