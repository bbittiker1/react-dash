...
import { fetchAnomalies } from "../../../actions/anomalies";
...
class ChangelogTable extends Component {
    ...
    static propTypes = {
        ...
        anomalies: PropTypes.array, // eslint-disable-line
    ...
    componentDidMount() {
        this.props.dispatch(fetchAnomalies());
    }
            ...
            <div>
                <div style={{marginBottom: '20px'}}>
                    <Breadcrumbs aria-label="breadcrumb">
                        ...
                        {/*    Anomalies*/}
                        {/*</Link>*/}
                        <Typography color="textPrimary">Anomalies</Typography>
