...
// import Legend from "./AnomalyBaselineCountLegend";
...
export default function AnomalyBaselineCount() {
    ...
    useEffect( () => {
        ...
        async function fetchData(f, t, l) {
            setLoading(true);
            return await axiosInstance().get(APIS.anomalyBaselineCount(l, formatDate(f),formatDate(t)));
        }
    ...
    const title = "Anomaly Baseline Count";
...
connect(null, null)(AnomalyBaselineCount);
